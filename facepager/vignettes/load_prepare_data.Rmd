...
### Load a complete fp database with `fp_loaddatabase()`
...
### Load multiple fp databases with `fp_loaddatabases()`
...
```{r}
data <- fp_loaddatabase("../data/exampledata.db", "../data/exampledata2.db")
```
